...
export const UPDATE_TASK = gql`
  mutation updateTask($id: String!, $title: String!, $description: String!, $estimatedTime: Float!, $status: String!, $priority: String!, $untilDate: String, $review: String , $timeSpent: Float) {
    updateTask(taskInput: {_id: $id, title: $title, description: $description, estimatedTime: $estimatedTime, status: $status, priority: $priority, untilDate: $untilDate, review: $review, timeSpent: $timeSpent }) {
      _id
      title
      description
      estimatedTime
