...
import { QUERY_TASKS_LIST, QUERY_TASKS_LIST_BY_KEYWORD } from '../../graphql/tasksQuery';
...
const Search = () => {
    ...
    const [getMatchingTasks, matchingTasksResult] = useLazyQuery(QUERY_TASKS_LIST_BY_KEYWORD, {variables: {keyword : keyword}})
