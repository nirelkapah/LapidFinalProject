...
import { selectSuccessAlertMessage, selectErrorAlertMessage } from '../../redux/web/webSelectors';
...
function dispatch(arg0: { payload: string; type: "web/updateSuccessAlertMessage"; }) {
